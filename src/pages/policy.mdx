...
**Important:** When you deploy EasyLayer's packages (`@easylayer/bitcoin-crawler`, `@easylayer/evm-crawler`, etc.), all blockchain data and application data stays entirely on YOUR infrastructure. We never see, access, or collect data from your self-hosted deployments.
