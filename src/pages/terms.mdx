...
**Key AGPL requirement:** If you modify `@easylayer/bitcoin-crawler` or `@easylayer/evm-crawler` and offer it as a service (including internal company use accessible over network), you must publish your modifications under AGPL-3.0.
...
**Special notice for AGPL packages (`@easylayer/bitcoin-crawler`, `@easylayer/evm-crawler`):**
