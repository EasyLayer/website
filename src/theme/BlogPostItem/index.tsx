...
interface BlogPostItemWrapperProps {
  [key: string]: any;
}

const BlogPostItemWrapper: React.FC<BlogPostItemWrapperProps> = (props) => {
  return (
    <>
      <BlogPostItem {...props} />
...
const DiscussionIcon: React.FC = () => (
  <svg height="100%" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <title>Discussions</title>
    <path d="M20 2H4c-1.1 0-2 .9-2 2v14l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 12H6.83L4 18.83V4h16v10z" />
  </svg>
);

const JoinOurCommunityCard: React.FC = () => {
  const JoinOurCommunityButton: React.FC = () => (
    <Link to="https://github.com/EasyLayer/core/discussions">
  ...
  return (
    ...
    >
      ...
      <p>EasyLayer is 100% open source. Join our Forum to learn from others and get help whenever you need it!</p>
...
const JoinNewsletterCard: React.FC = () => {
  return (
    <div
      className="
        flex flex-col items-start
    ...
    >
      ...
      <p>Once per month - receive useful blog posts and EasyLayer news.</p>
